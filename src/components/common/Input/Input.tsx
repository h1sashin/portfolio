...
export const Input: React.FC<InputProps> = ({ label, error, ...props }) => {
    return (
        <div className="relative h-16 bg-secondary flex mb-4 items-end pt-2">
            <input
                type="text"
                id={props.name}
                className={`text-white transition-colors peer px-4 bg-transparent text-xl h-16 pt-4 w-full outline-none border-b ${
